...
import com.example.adminmengo.databinding.ActivitySignUpBinding
import com.example.adminmengo.model.UserModel
    ...
    private fun createAccount(email: String, password: String) {
        auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener { task ->
            if (task.isSuccessful) {
                ...
                Toast.makeText(
                    this,
                    "Account Creation Failed BYGLD: ${task.exception}",
                    Toast.LENGTH_SHORT
                ).show()
