package com.example.adminmengo.adapters
...
import com.example.adminmengo.databinding.DeliveryItemBinding
...
class DeliveryAdapter(
    ...
    inner class ViewHolder(private val binding: DeliveryItemBinding) :
