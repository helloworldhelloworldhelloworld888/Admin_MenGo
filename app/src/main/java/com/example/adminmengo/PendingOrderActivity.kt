...
import com.example.adminmengo.adapters.PendingOrderAdapter
import com.example.adminmengo.databinding.ActivityPendingOrderBinding
import com.example.adminmengo.model.OrderDetails
...
class PendingOrderActivity : AppCompatActivity(), PendingOrderAdapter.OnItemClicked {
    ...
    override fun OnItemDispatchClickListener(position: Int) {
        ...
        val dispatchItemOrderReference =
            database.reference.child("Completed Orders").child(dispatchItemPushKey!!)
